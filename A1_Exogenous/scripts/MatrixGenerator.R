...
rna_editing_table <- read.csv('/Users/benfixman/Library/Mobile Documents/com~apple~CloudDocs/Chen_Lab/RNA_SBS/A1_RBM46_circSeq/Data/variants/filtered_variants.csv')
...
write.table(trinuc_mat, '/Users/benfixman/Library/Mobile Documents/com~apple~CloudDocs/Chen_Lab/RNA_SBS/A1_RBM46_circSeq/Data/matrices/matrix_192.tsv', quote = FALSE, sep = "\t")
