...
gtf_txdb <- makeTxDbFromGFF("/Users/benfixman/Library/Mobile Documents/com~apple~CloudDocs/Chen_Lab/PRJNA261741/gencode.v43.annotation.gtf", format = "gtf")

# Check and fix sequence names
gtf_file <- "/Users/benfixman/Library/Mobile Documents/com~apple~CloudDocs/Chen_Lab/PRJNA261741/gencode.v43.annotation.gtf"
...
rna_editing_table <- read.csv("/Users/benfixman/Library/Mobile Documents/com~apple~CloudDocs/Chen_Lab/PRJNA261741/data/variants/variants.csv")
...
write.table(trinuc_mat, "/Users/benfixman/Library/Mobile Documents/com~apple~CloudDocs/Chen_Lab/PRJNA261741/data/Matrices/matrix_192.tsv", quote = FALSE, sep = "\t")
