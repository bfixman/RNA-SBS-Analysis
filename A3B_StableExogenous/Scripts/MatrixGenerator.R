...
rna_editing_table <- read.csv("/Users/benfixman/Library/Mobile Documents/com~apple~CloudDocs/Chen_Lab/RNA_SBS/A3B RNA Editing/Data/Variants/a3b_variants.csv")
...
write.table(trinuc_mat, '/Users/benfixman/Library/Mobile Documents/com~apple~CloudDocs/Chen_Lab/RNA_SBS/A3B RNA Editing/Data/Matrices/matrix_192.tsv', quote = FALSE, sep = "\t")
